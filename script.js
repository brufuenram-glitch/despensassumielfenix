...
const CONFIG = {
  ...
  products: {
    'despensa-clasica': {
      id:          'despensa-clasica',
      name:        'Despensa Clásica',
      category:    'Despensas',
      description: 'Canasta con productos básicos de primera necesidad. Ideal para colaboradores de línea operativa y administrativa.',
      items: [
        'Aceite vegetal 1L',
        'Azúcar 1kg',
        'Arroz 1kg',
    ...
    'despensa-ejecutiva': {
      id:          'despensa-ejecutiva',
      name:        'Despensa Ejecutiva',
      category:    'Despensas',
      description: 'Versión premium con productos de marca reconocida. Selección curada para mandos medios, ejecutivos y directivos.',
      items: [
        'Aceite de oliva premium',
        'Café molido de especialidad',
        'Chocolates artesanales',
        'Mermeladas gourmet x2',
        'Galletas finas',
        'Té de hierbas selecto',
    ...
    'arcon-premium': {
      id:          'arcon-premium',
      name:        'Arcón Navideño Premium',
      category:    'Arcones',
      description: 'Arcón elegante diseñado para impresionar. Contenido premium con presentación navideña de alta gama para clientes VIP y directivos.',
      items: [
        'Vino tinto seleccionado',
        'Chocolates Godiva x2',
        'Queso manchego curado',
        'Jamón serrano',
        'Frutos secos premium',
        'Galletas artesanales',
        'Miel de abeja premium',
        'Aceite de oliva extra virgen',
        'Mermelada artesanal',
        'Presentación navideña exclusiva',
      ],
    },
    'arcon-empresarial': {
      id:          'arcon-empresarial',
      name:        'Arcón Empresarial',
      category:    'Arcones',
      description: 'Arcón corporativo de gran volumen para pedidos masivos. Contenido personalizable según perfil y presupuesto de tu empresa.',
      items: [
        'Bebidas seleccionadas',
        'Botanas premium',
        'Repostería artesanal',
        'Productos gourmet variados',
        'Presentación con logo empresarial',
        'Listón y moño corporativo',
        'Tarjeta personalizada',
        'Embalaje seguro para envío',
      ],
    },
    'canasta-corporativa': {
